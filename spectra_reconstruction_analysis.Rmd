...
#i am pretty sure that 'reconstructions' is the right table for the variable of the same name used for cossim calculation in plot_recons, but will have to check results to confirm 
...
for (i in 1:nsamp) {
  print(cosine_sim(counts[i,], colSums(recons[i, , ])))
}
